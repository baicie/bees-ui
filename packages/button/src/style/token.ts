...
import type { FullToken, GetDefaultToken } from '@baicie/core';
...
export interface ButtonToken extends FullToken<'Button'> {
  buttonPaddingHorizontal: JSX.CSSProperties['padding-inline'];
  buttonPaddingVertical: JSX.CSSProperties['padding-block'];
