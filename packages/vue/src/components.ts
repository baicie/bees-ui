...
export const IkunButton = /*@__PURE__*/ defineContainer<JSX.IkunButton>(
  "ikun-button",
  defineIkunButton,
  ["disabled"],
);

export const IkunConfigProvider =
  /*@__PURE__*/ defineContainer<JSX.IkunConfigProvider>(
    "ikun-config-provider",
    defineIkunConfigProvider,
    ["componentSize", "theme", "locale"],
  );
...
export const IkunWave = /*@__PURE__*/ defineContainer<JSX.IkunWave>(
  "ikun-wave",
  defineIkunWave,
  ["disabled"],
);
