...
declare global {
  ...
  interface HTMLBeesButtonElement extends Components.BeesButton, HTMLStencilElement {
    addEventListener<K extends keyof HTMLBeesButtonElementEventMap>(
      type: K,
      listener: (this: HTMLBeesButtonElement, ev: BeesButtonCustomEvent<HTMLBeesButtonElementEventMap[K]>) => any,
    ...
    removeEventListener<K extends keyof HTMLBeesButtonElementEventMap>(
      type: K,
      listener: (this: HTMLBeesButtonElement, ev: BeesButtonCustomEvent<HTMLBeesButtonElementEventMap[K]>) => any,
