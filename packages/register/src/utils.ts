...
type PCustomElementSlot = HTMLSlotElement | HTMLElement[];

export interface PCustomElement {
  [prop: string]: any;
...
export type UpdateableElement<T> = HTMLElement & PCustomElement & T;

export type ConstructableComponent<T> = new (props: T) => unknown;
export type FunctionComponent<T> = (props: T) => unknown;
