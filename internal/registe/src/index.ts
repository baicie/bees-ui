// @ts-nocheck
import { createSvelteSlots, findSlotParent, unwrap } from './util';
...
export default function svelteRetag(opts) {
  ...
  window.customElements.define(
    opts.tagname,
    class extends HTMLElement {
      attributesObserved: boolean;
      private _root: HTMLElement;
      slotEls: {};
      componentInstance: any;
      propMap: any;
      slotObserverActive: any;
      slotObserver: any;
      constructor() {
        super();
       ...
       * @param {string} value
       */
      forwardAttributeToProp(name: string, value: string) {
        // @ts-ignore
      ...
      _getLightSlots() {
        ...
        if (childHTML.trim() !== '') {
          ...
          if (slots.default) {
            ...
            console.error(
              `svelteRetag: '${this.tagName}': Found elements without slot attribute when using slot="default"`,
            );
          } else {
